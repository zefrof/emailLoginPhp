	    	...
	    	<?php if(isset($stop)){
				...
				<form role="form" method="post" action="" autocomplete="off">
					...
					<div>
						...
						<div>
							<div>
								<input type="password" name="passwordConfirm" id="passwordConfirm" placeholder="Confirm Password" tabindex="1">
							</div>
						</div>
					</div>
					...
					<hr>
					<div>
						<div><input type="submit" name="submit" value="Change Password" tabindex="3"></div>
					</div>
				</form>
